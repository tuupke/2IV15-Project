...
To get a feeling for the effect of the timestep on the stability of a system, we used a scene with two particles, 0.2 units apart, coupled by one spring. The particles have a mass of 1 unit and the spring has a rest length $\mathbf{r}$ of 0.4, a $k_s$ of 0.5 and a $k_d$ of 0.1.
\begin{table}[h]
\begin{tabular}{|l|l|l|}
\hline
\textbf{Timestep} & \textbf{Convergent} & \textbf{Remark}                 \\ \hline
0.05              & Yes                 &                                 \\ \hline
0.10              & Yes                 &                                 \\ \hline
0.15              & Yes                 & Converges only after many steps \\ \hline
0.20              & No                  &                                 \\ \hline
\end{tabular}
\end{table}
